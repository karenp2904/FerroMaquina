...
public class Tiquete {
	...
	public LinkedList<RutaTren> listaRutas(){
		...
		ruta= new RutaTren(tren,"Bucaramanga","Bogota",
				LocalDateTime.of(2023, 03, 23, 6, 0),
				LocalDateTime.of(2023, 03, 23, 13, 0));
		rutasLista.add(ruta);
		
		tren=new Tren("002");;
		ruta= new RutaTren(tren,"Bucaramanga","Bogota",
				LocalDateTime.of(2023, 03, 23, 9, 0),
				LocalDateTime.of(2023, 03, 23, 17, 0));
		rutasLista.add(ruta);
		
		tren=new Tren("003");;
		ruta= new RutaTren(tren,"Bucaramanga","Bogota",
				LocalDateTime.of(2023, 03, 23, 11, 0),
				LocalDateTime.of(2023, 03, 23, 19, 0));
		rutasLista.add(ruta);
		
		tren=new Tren("004");;
		ruta= new RutaTren(tren,"Bucaramanga","Bogota",
				LocalDateTime.of(2023, 03, 23, 1, 0),
				LocalDateTime.of(2023, 03, 23, 21, 0));
		rutasLista.add(ruta);
